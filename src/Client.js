...
class Client extends EventEmitter {
    ...
    async initialize() {
        ...
        // let chromePath = path.resolve("../build/puppeteer/.local-chromium/win64-818858/chrome-win/chrome.exe")
        // let chromePath = path.resolve("build/puppeteer/.local-chromium/win64-818858/chrome-win/chrome.exe")
        // let chromePath = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe'
        // this.options.puppeteer.executablePath =  chromePath
        this.options.puppeteer.executablePath = chromiumExecutablePath,
        console.log('this.options.puppeteer2',this.options.puppeteer)
        ...
        if (this.options.session) {
            ...
            const getQrCode = async () => {
                ...
                console.log(QR_CANVAS_SELECTOR)
                let res = await page.waitForSelector(QR_CANVAS_SELECTOR, { timeout: this.options.qrTimeoutMs });
                console.log('page.waitForSelector2')
                // console.log('page.waitForSelector2', res)
                const qrImgData = await page.$eval(QR_CANVAS_SELECTOR, canvas => [].slice.call(canvas.getContext('2d').getImageData(0, 0, 264, 264).data));
                // const qrImgData = await eval(`page.$eval(${QR_CANVAS_SELECTOR}, canvas => { console.log('1'); console.log(canvas); }) `)
                console.log('qrImgData')
